...
const en: I18nMessages = {
  ...
  provision: {
    ...
    mqttRegistration: {
      ...
      enabled: 'Enabled',
      disabled: 'Disabled',
      orionConnectivity: 'Orion Connectivity',
      reachable: 'Reachable',
      unreachable: 'Unreachable',
      mqttRuntime: 'MQTT Runtime',
      connected: 'Connected',
      disconnected: 'Disconnected',
      testOrionConnection: 'Test Orion Connection',
      registerGateway: 'Register Gateway',
      openMqttConfig: 'Open MQTT Config',
      notRegisteredWarning: 'Gateway is not registered with Orion',
      registeredSuccess: 'Gateway is registered with Orion',
  ...
  config: {
    ...
    mqtt: {
      ...
      telemetryNotice: 'Telemetry is configuration only; publisher is not implemented yet.',
